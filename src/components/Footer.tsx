      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm text-slate-400 max-w-sm leading-relaxed">
              Multi-destination travel packages and reservation orchestration.
              Explore more, travel smarter — your journey across India starts here.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/bookings" className="hover:text-teal-400 transition-colors">My Bookings</Link></li>
              <li><Link to="/login" className="hover:text-teal-400 transition-colors">Login / Register</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-slate-800 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-slate-500">
            &copy; {new Date().getFullYear()} TripFlow. SOA Programming & Microservices College Project.
          </p>
          <p className="text-xs text-slate-500">
